        ...
        <div class='col-md-4 my-auto' style='margin: 0 auto;'>
            ...
            <table>
                ...
                <%
                    ...
                    %>
                        <script>
                            window.location.replace("createOrder.jsp");
                        </script>
                    <%
                    }
                ...
                <tr>
                    ...
                    <td><a href="createOrder.jsp?r=<%=res.getString("product_id")%>">Remove</a></td>
                </tr>
                <%
                            quantityCounter++;
                        }
            ...
            <div class="mt-2 mr-2" style="text-align: right">
                <button class="btn btn-default bg-primary text-white mr-2" name="payBtn">Order Now</button>
                <button class="btn btn-default bg-light" name="continueBtn">Continue Shopping</button>
            </div>                        
            <%
                } else {
            %>
